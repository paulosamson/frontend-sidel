...
gulp.task('copy-assets', function(){
  return gulp.src(['src/*.html', 'src/media/**', 'src/fonts/**', 'src/scripts/pkgd-**.min.js', 'src/scripts/assets/**', 'src/images/{,*/}*.{svg,ico}'], {base: "./src"})
...
gulp.task('build-noimages', function(callback) {
  runSequence('clean', 'html', 'sass-build', 'copy-assets', 'scripts-build');
});
